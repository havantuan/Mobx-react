...
export class HubTableStore {
  ...
  fetch = (filter, pagination, order = []) => {
    let query = `
        query DataSources($Page: Int = 1, $Limit: Int = 10, $Order: [Sort], $State: EnumState, $Accessibility: EnumAccessibility, $Query: String) {
            Hubs(Pageable: {Page: $Page, Limit: $Limit, Sorts: $Order}, State: $State, Accessibility: $Accessibility, Query: $Query) {
                Items {
                  Accessibility {
                    Code
                    Name
